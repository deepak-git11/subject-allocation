...
<input  type="radio" value="Tutor" id="Tutor" name="Tutor" > TUTOR</input>
<label for="Classname"><b>Classname :<b></label>
<type="text" id="Classname" name="Classname" style="margin-left: 10px; margin-right: 50px;  border: 1px solid black;">
<select id="mySelect" name="Classname">
<option value="" > select class </option> 
<option value="I BSC CS-A"  >I BSC CS-A  </option> 
  <option value="I BSC CS-B"  >I BSC CS-B </option>
  <option value="II BSC CS-A" >II BSC CS-A</option>
  <option value="II BSC CS-B" >II BSC CS-B</option>
  <option value="III BSC CS-A">III BSC CS-A</option>
  <option value="III BSC CS-B">III BSC CS-B</option>
