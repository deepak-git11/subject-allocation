...
<script>
	function redirecttonextpage(){
		window.open('BTECHLIST.php','_blank');
	}
</script>
</head>
...
<div>
<?php
    $sqlSelect1 = "SELECT CrCode,CrName,convert(SUBSTRING(CrCode, 4),decimal) AS `cr1` FROM sheet1 where CrCode not like 'CSE%' order by Cr1 asc";

    $result1 = $db->query($sqlSelect1);
   
?>

<h1 style="text-align:center;">BTECH DEPARTMENT</h1>
