...
<head>
<title>BCA allocate</title>
<script>
	function redirecttonextpage(){
		window.open('BCALIST.php','_blank');
	}
</script>
</head>
<body>
...
<div>
<?php
    $sqlSelect1 = "SELECT CrCode,CrName,convert(SUBSTRING(CrCode, 4),decimal) AS `cr1` FROM sheet1 where CrCode not like 'CAP%' order by Cr1 asc";

    $result1 = $db->query($sqlSelect1);
   
?>
<h1 style="text-align:center;">BCA DEPARTMENT SELECTED COURSE</h1>
