...
<head>
<title>
    PREFERNCE_LIST_INCLUDE_DUPLICATE
</title>
<style>
   h2{
      text-align:center;
...
<ul>
  ...
  <li>
      ...
      <ul class="submenu">
        ...
        <li><a href='#' >PrefList- Duplication</a></li>
...
<h2>STAFF AND THEIR PREFERENCE COURSES WITH DUPLICATION</h2>
<?php
  ...
  $sqlSelect = 
    "SELECT  P1.Sno,
               ...
               FROM pref P1, tbl_login x1
                                  where  P1.Sno=x1.col_number order by Sno1 Asc, TimeStamp Desc";
